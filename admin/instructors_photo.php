...
if(isset($_FILES['photo']))
{
  ...
  set_message('Instructor photo has been updated');
  header('Location: instructors.php');
  die();
}
...
if(isset($_GET['id']))
{
  if(isset($_GET['delete']))
  {
    ...
    set_message('Instructor photo has been deleted');
    header('Location: instructors.php');
    die();
  }
...
<p>Note: For best results, photos should be approximately 400 x 400 pixels.</p>
...
<?php if($record['photo']): ?>
  ...
  ?>
  <p><img src="data:image/jpg;base64,<?php echo base64_encode($data); ?>" width="200" height="200" style="border-radius: 50%;"></p>
  <p><a href="instructors_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
<?php endif; ?>
